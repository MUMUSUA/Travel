...
//        username=getArguments().getString("name");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(mRecord.getId()==null)
            ...
            mPicture.setImageBitmap(mRecord.getPhotoId());

        if(id==null)
        {  mPicture.setImageResource(R.drawable.upload);
            mPicture.buildDrawingCache();
            b=mPicture.getDrawingCache();
            b=((BitmapDrawable)mPicture.getDrawable()).getBitmap();
            mRecord.setPhotoId(b);}
        else
            mPicture.setImageBitmap(mRecord.getPhotoId());
...
//        mChooseCity.setOnClickListener(this);
        ...
        Log.i("mCityResult","------------------>"+mRecord.getAddress());
        ...
        if(mRecord.getDesc()!=null)
        {
            mDesc.setText(mRecord.getDesc().toString());
            mRecord.setDesc(mDesc.getText().toString());}
        else
            mRecord.setDesc(mDesc.getText().toString());
        ...
        mAddCity=(ImageButton)v.findViewById(R.id.record_add);
